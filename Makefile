...
HTTPS_GIT := https://github.com/1119-Labs/slinky.git
...
BUILD_TAGS := -X github.com/1119-Labs/slinky/cmd/build.Build=$(TAG)
...
docker-build:
	...
	docker buildx build -t ghcr.io/1119-labs/slinky-base             -f contrib/images/slinky.base.Dockerfile .         	   --platform linux/amd64,linux/arm64
	docker buildx build -t ghcr.io/1119-labs/slinky-e2e-sidecar      -f contrib/images/slinky.sidecar.e2e.Dockerfile .      --platform linux/amd64,linux/arm64
	docker buildx build -t ghcr.io/1119-labs/slinky-local-app        -f contrib/images/slinky.local.Dockerfile .      	   --platform linux/amd64,linux/arm64
	docker buildx build -t ghcr.io/1119-labs/slinky-market-simulator -f contrib/images/slinky.market.simulator.Dockerfile . --platform linux/amd64,linux/arm64
	docker buildx build -t ghcr.io/1119-labs/slinky-sidecar          -f contrib/images/slinky.sidecar.Dockerfile .      	   --platform linux/amd64,linux/arm64
	docker buildx build -t ghcr.io/1119-labs/slinky-sidecar-dev      -f contrib/images/slinky.sidecar.dev.Dockerfile .      --platform linux/amd64,linux/arm64
	docker buildx build -t ghcr.io/1119-labs/slinky-sim-app          -f contrib/images/slinky.sim.app.Dockerfile .     	   --platform linux/amd64,linux/arm64

docker-push:
	@echo "Pushing Docker images..."
	docker buildx build -t ghcr.io/1119-labs/slinky-base             -f contrib/images/slinky.base.Dockerfile .         	   --platform linux/amd64,linux/arm64 --push
	docker buildx build -t ghcr.io/1119-labs/slinky-e2e-sidecar      -f contrib/images/slinky.sidecar.e2e.Dockerfile .      --platform linux/amd64,linux/arm64 --push
	docker buildx build -t ghcr.io/1119-labs/slinky-local-app        -f contrib/images/slinky.local.Dockerfile .      	   --platform linux/amd64,linux/arm64 --push
	docker buildx build -t ghcr.io/1119-labs/slinky-market-simulator -f contrib/images/slinky.market.simulator.Dockerfile . --platform linux/amd64,linux/arm64 --push
	docker buildx build -t ghcr.io/1119-labs/slinky-sidecar          -f contrib/images/slinky.sidecar.Dockerfile .      	   --platform linux/amd64,linux/arm64 --push
	docker buildx build -t ghcr.io/1119-labs/slinky-sidecar-dev      -f contrib/images/slinky.sidecar.dev.Dockerfile .      --platform linux/amd64,linux/arm64 --push
	docker buildx build -t ghcr.io/1119-labs/slinky-sim-app          -f contrib/images/slinky.sim.app.Dockerfile .     	   --platform linux/amd64,linux/arm64 --push
...
.PHONY: docker-build e2e-docker-build docker-build-sidecar docker-push-sidecar

# docker-build-sidecar builds just the sidecar image (including base dependency)
docker-build-sidecar:
	@echo "Building slinky-sidecar image..."
	docker buildx build -t ghcr.io/1119-labs/slinky-base:latest -f contrib/images/slinky.base.Dockerfile . --platform linux/amd64,linux/arm64
	docker buildx build -t ghcr.io/1119-labs/slinky-sidecar:latest -f contrib/images/slinky.sidecar.Dockerfile . --platform linux/amd64,linux/arm64

# docker-push-sidecar builds and pushes just the sidecar image (including base dependency)
docker-push-sidecar:
	@echo "Building and pushing slinky-sidecar image..."
	docker buildx build -t ghcr.io/1119-labs/slinky-base:latest -f contrib/images/slinky.base.Dockerfile . --platform linux/amd64,linux/arm64 --push
	docker buildx build -t ghcr.io/1119-labs/slinky-sidecar:latest -f contrib/images/slinky.sidecar.Dockerfile . --platform linux/amd64,linux/arm64 --push
...
format:
	...
	@find . -name '*.go' -type f -not -path "*.git*" -not -path "/*mocks/*" -not -name '*.pb.go' -not -name '*.pulsar.go' -not -name '*.gw.go' | xargs go run golang.org/x/tools/cmd/goimports -w -local github.com/1119-Labs/slinky
