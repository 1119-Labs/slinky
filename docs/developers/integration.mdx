...
First, add the [x/marketmap](https://github.com/1119-Labs/slinky/blob/main/x/marketmap/README.md) and [x/oracle](https://github.com/1119-Labs/slinky/tree/main/x/oracle) keepers to the application.
