...
import QuickStartPerpxSnippet from '/snippets/perpx-quickstart.mdx';
...
```bash
curl -sSL https://raw.githubusercontent.com/1119-Labs/slinky/main/scripts/install.sh | sudo bash
```

### From GitHub Releases

Head over to our [GitHub Releases](https://github.com/1119-Labs/slinky/releases) page and download the binary that matches your machine's architecture.
...
```shell
git clone git@github.com:1119-Labs/slinky.git
cd slinky
...
<Tabs>
    ...
    <Tab title="Perpx Blockchain">
        <QuickStartPerpxSnippet />
    </Tab>
