...
import (
	...
	"github.com/1119-Labs/slinky/providers/apis/bitstamp"
	...
	"github.com/1119-Labs/slinky/providers/apis/kraken"
...
// ProviderMapping is referencing the different providers that are supported by the Perpx market params.
//
// ref: https://github.com/1119-Labs/perpx/blob/main/protocol/daemons/pricefeed/client/constants/exchange_common/exchange_id.go
...
// ConvertMarketParamsToMarketMap converts a Perpx market params response to a slinky market map response.
...
// CreateTickerFromMarket creates a ticker from a Perpx market.
func CreateTickerFromMarket(market perpxtypes.MarketParam) (mmtypes.Ticker, error) {
...
// CreateCurrencyPairFromPair creates a currency pair from a Perpx market.
...
// from a Perpx market. These paths represent the different ways to convert a currency
// pair using the Perpx market.
func ConvertExchangeConfigJSON(
	...
	var (
		...
		seen      = make(map[perpxtypes.ExchangeMarketConfigJson]struct{})
	)
...
func ExtractMetadata(providerName string, cfg perpxtypes.ExchangeMarketConfigJson) (string, error) {
