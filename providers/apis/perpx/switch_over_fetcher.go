...
import (
	...
	slinkygrpc "github.com/1119-Labs/slinky/pkg/grpc"
...
// perpx x/prices market map fetcher and a x/marketmap fetcher. The fetcher
...
type SwitchOverFetcher struct {
	...
	// pricesFetcher is the fetcher for the perpx x/prices market map.
...
// Perpx x/prices and x/marketmap fetchers.
func NewDefaultSwitchOverMarketMapFetcher(
	...
	// Construct the Perpx x/prices API handler.
	...
	// Construct the Perpx x/marketmap API handler.
