...
const (
	...
	// SwitchOverAPIHandlerName is the name of the Perpx switch over API.
	SwitchOverAPIHandlerName = "perpx_migration_api"

	// ResearchAPIHandlerName is the name of the Perpx research json API.
	ResearchAPIHandlerName = "perpx_research_json_api"

	// ResearchCMCAPIHandlerName is the name of the Perpx research json API that only returns CoinMarketCap markets.
	ResearchCMCAPIHandlerName = "perpx_research_coinmarketcap_api"

	// ChainID is the chain ID for the Perpx market map provider.
	ChainID = "perpx-node"

	// Endpoint is the endpoint for the Perpx market map API.
	Endpoint = "%s/perpxprotocol/prices/params/market?pagination.limit=10000"
...
// DefaultAPIConfig returns the default configuration for the Perpx market map API.
...
// DefaultSwitchOverAPIConfig returns the default configuration for the Perpx switch over API provider.
...
// DefaultResearchAPIConfig returns the default configuration for the Perpx market map API.
var DefaultResearchAPIConfig = config.APIConfig{
	...
	Endpoints: []config.Endpoint{
		{
			URL: "https://perpx-api.example.com",
		},
		{
			URL: "https://raw.githubusercontent.com/1119-Labs/perpx/main/configs/marketData.json",
		},
	},
}

// DefaultResearchCMCAPIConfig returns the default configuration for the Perpx market map API that only returns CoinMarketCap markets.
...
// UniswapV3MetadataFromTicker returns the metadataJSON string for uniswapv3_api according to the Perpx encoding.
...
// All raydium tickers on perpx will be formatted as follows
